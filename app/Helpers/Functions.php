...
{
    return "frontend.templates." . $page;
}

function load_sitemap_template($page, $data = [])
{
    return response()->view('frontend.sitemaps.' . $page, $data)->header('Content-Type', 'text/xml');
}
...
{
    return view('frontend.templates.social-share', ['title' => $title, 'permalink' => $permalink]);
}
